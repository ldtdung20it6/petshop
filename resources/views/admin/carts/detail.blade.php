...
@section('content')
    <div class="customer mt-3">
        <ul>
            ...
            <li>Chế Độ Giao Hàng: <strong>{{ $customer-> giaohang }}</strong></li>
            <li>Chế Độ Thanh Toán: <strong>{{ $customer-> thanhtoan }}</strong></li>
            <li>Mã Giao Dịch: <strong>{{ $customer-> magiaodich }}</strong></li>
        </ul>
    </div>
