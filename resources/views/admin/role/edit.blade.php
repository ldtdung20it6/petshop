...
<form action="" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password" value="{{$user->password}}" class="form-control" placeholder="Nhập Mật Khẩu">
                  </div>

                  <div class="form-group">
                    <label for="menu">Số Điện Thoại</label>
                    <input type="integer" name="phone" value="{{$user->phone}}" class="form-control" placeholder="Nhập số điện thoại">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" value="{{$user->thumb}}" id="upload">
                    <div id="image_show">
